...
def app(_,s_state):
    ...
    **Credits**
    - App built in `Python` + `Streamlit` by [José Teófilo Moreira Filho & Henric P. V. Gil](http://lattes.cnpq.br/3464351249761623), , Rodolpho C. Braga, Vinicius M. Alves , Bruno J. Neves, and Carolina H. Andrade.
